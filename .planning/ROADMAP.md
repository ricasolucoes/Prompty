...
- [x] **Phase 6: Geração de Imagem in-app** — Edge Function provider-agnostic com débito atômico, refund e UX completo (completed 2026-06-21)
...
| 6. Geração de Imagem in-app | 3/3 | Complete   | 2026-06-21 | - |
