...
- [x] **CUR-01**: L2 user can upload a generated image as a Prompty result (with notes)
- [x] **CUR-02**: L2 user can rate a Prompty quality (simple 1-5 or thumbs)
...
- [x] **CREAT-02**: L3 user can set complexity_level (simple/guided/advanced)
